...
//! - Arrow-native results as RecordBatches for zero-copy integration
...
//!     (OptionDatabase::Uri, "https://xxx.cloud.databricks.com".into()),
//!     (OptionDatabase::Other("databricks.warehouse_id".into()), "abc123".into()),
//!     (OptionDatabase::Other("databricks.token".into()), "dapi...".into()),
//! ])?;
//!
